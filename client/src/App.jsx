...
function CookieConsent() {
    var _a = useState(false), showConsent = _a[0], setShowConsent = _a[1];
    useEffect(function () {
    ...
    return (<div className="fixed bottom-4 left-4 z-50 max-w-md bg-white shadow-lg rounded-lg border border-gray-200 p-4">
      <div className="mb-4">
